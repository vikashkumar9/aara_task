...
const data = [
  { week: "03 Mar", B_I: 8, Eng: 71, FnB: 43, HK: 2, total: 124 },
  { week: "10 Mar", B_I: 6, Eng: 42, FnB: 9, HK: 3, total: 60 },
  { week: "17 Mar", B_I: 4, Eng: 45, FnB: 52, HK: 7, total: 108 },
  { week: "24 Mar", B_I: 17, Eng: 62, FnB: 55, HK: 1, total: 135 },
];

const AdoptWeeklyTrendGraph = () => {
  return (
    <ResponsiveContainer width="100%" height={400}>
      <BarChart data={data} margin={{ top: 20, right: 30, left: 20, bottom: 20 }} barSize={40}>
        ...
        <XAxis 
          dataKey="week" 
          label={{ value: "Week Starting", position: "insideBottom", offset: -5, fill: "#30879f", fontSize: "14px" }} 
        />
        <YAxis 
...
export default AdoptWeeklyTrendGraph;
