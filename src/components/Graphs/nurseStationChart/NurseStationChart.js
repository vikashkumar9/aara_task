...
const data = [
  { name: "1st Floor / 1f(82 Em)", requests: 99 },
  { name: "2nd Floor / 2f(14 Em)", requests: 18 },
  { name: "Ground Floor / Gf(82 Em)", requests: 9 },
  { name: "2nd Floor / 2f(82 Em)", requests: 8 },
];

const NurseStationChart = () => {
  return (
...
export default NurseStationChart;
